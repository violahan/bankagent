...
Connects to the CreditServicesMCP server, fetches the relevant policy rules, and
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--mcp-url", default=DEFAULT_MCP_URL, help="CreditServicesMCP streamable-HTTP URL")
